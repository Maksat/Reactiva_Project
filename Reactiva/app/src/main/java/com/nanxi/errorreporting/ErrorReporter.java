...
package com.nanxi.errorreporting;
...
public class ErrorReporter extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Throwable error = (Throwable) getIntent().getSerializableExtra("reactiva_error");
        if (error != null) {

            StringBuilder builder = new StringBuilder();
            builder.append("Reactiva Error Report:");
