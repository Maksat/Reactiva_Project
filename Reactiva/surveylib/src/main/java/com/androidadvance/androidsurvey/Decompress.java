...
public class Decompress {
    ...
    public Decompress( File zipFile) {
        _zipFile = zipFile;
        rootLocation = zipFile.getParent();
        Log.i(TAG, "Root location: "+rootLocation);
        _dirChecker("");
    }
        ...
        try  {
            ...
            while ((ze = zin.getNextEntry()) != null) {
                ...
                if(ze.isDirectory()) {
                    ...
                    File file = new File(rootLocation, ze.getName());
                    ...
                    fout.close();
                    zin.closeEntry();
                    Log.v(TAG, "Created file: "+file.getAbsolutePath());
                }
